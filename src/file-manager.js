...
import {setBaseUrl, setHeaders, setPostData, setQueryParams} from './services/HttpService';
...
import PJpeg, {injection as PJpegInjection, PJPEG} from './plugins/progressive_jpeg';
